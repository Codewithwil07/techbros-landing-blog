...
const StatsSection: React.FC = () => {
  ...
  return (
    <section className="pt-16 pb-0 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
            ...
            return (
              ...
              >
                <div className="relative stats-icon-group w-16 h-16 flex items-center justify-center shrink-0 mb-4">
                  <div className="relative z-10 w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-sm rotate-45 flex items-center justify-center">
