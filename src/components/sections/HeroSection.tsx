...
const HeroSection: React.FC = () => {
  ...
  return (
    <section
      id="beranda"
      className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"
    >
      <div className="max-w-7xl mx-auto text-center mb-16 mt-14">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            techbros siap membantu kamu menyelesaikan tugas coding dengan
            cepat, profesional, dan terpercaya. Mulai dari web development,
            aplikasi mobile, hingga algoritma kompleks — serahkan semua ke kami!
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center text-red">
            <a
              href="https://wa.me/6287767978358?text=Halo%20saya%20tertarik%20dengan%20layanan%20Anda"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-green-500 text-white px-4 py-3 rounded-md hover:bg-green-600 transition"
            >
      ...
      >
        <DotAbstrcat ClassName=" -top-14 -z-10" />

        <DotAbstrcat ClassName=" -bottom-14 left-[60rem] -z-10" />

        <div className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-3xl p-8 shadow-2xl">
          <div className="bg-gray-900 rounded-2xl p-8 font-mono text-green-400 shadow-inner">
